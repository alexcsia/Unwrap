...
The system currently supports two types of exclusions, each with a different scope:
...
- [API Reference: GET exclusions ](../API%20Reference/GET%20exclusions.md)
- [API Reference: POST exclusions ](../API%20Reference/POST%20exclusions.md)
- [API Reference: DELETE exclusions ](../API%20Reference//DELETE%20exclusions.md)
